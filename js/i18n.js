...
const I18N = {
  zh: {
    // --- Landing Page ---
    // Nav
    brandName: "插台 SkillMesh",
    ecoTagMCP: "Anthropic · 工具连接",
    ecoTagA2A: "Google · Agent 通信",
    ecoTagSkills: "Anthropic · 能力描述",
    comingSoon: "即将上线",
    forWhomCard1Li1: "LangChain / MCP / DSH / CrewAI 多框架适配",
    forWhomCard1Li2: "5 行代码接入，npm install / pip install 即用",
    forWhomCard1Li3: "能力贡献后自动出现在联邦搜索",
    forWhomCard1Li4: "信任向量自动更新，高质量能力优先展示",
    forWhomCard2Li1: "Dify 插件即将上线（阶段十）",
    forWhomCard2Li2: "MCP 协议一键连接，无需写代码",
    forWhomCard2Li3: "自然语言搜索能力，不用记 ID",
    forWhomCard2Li4: "在线 Playground 直接体验每个能力",
    aboutVerifyLi1: "当前状态：协议就绪，数据积累中",
    aboutVerifyLi2: "成功标准：≥ 5 个真实外部贡献者，≥ 2 个独立联邦节点",
    aboutVerifyLi3: "证伪条件：3 个月内无外部采用",
    aboutNotLi1: "互补于 MCP：CCP 搜索 + MCP 连接",
    aboutNotLi2: "互补于 A2A：CCP 信任 + A2A 通信",
    aboutNotLi3: "互补于 Skills：CCP 信任 + Skills 描述",
    ...
    aboutMoreLi2Desc: " — 阶段十规划与里程碑",
    aboutMoreLi3Title: "API 文档",
    aboutMoreLi3Desc: " — OpenAPI 3.0 规范 + Swagger UI",
    aboutMoreLi4Title: "健康面板",
    aboutMoreLi4Desc: " — 联邦网络实时状态",
    aboutMoreLi5Title: "贡献者排行榜",
    aboutMoreLi5Desc: " — 查看社区贡献者",
    appHeroTitle: "发现可靠能力",
    appHeroTitleLight: " · 信任驱动选择",
    exportMCPLabel: "MCP 客户端",
    exportDifyDesc: "工具配置",
    navHome: "首页",
    navQuickstart: "快速开始",
    navExplore: "能力探索",
  ...
  en: {
    ...
    // Nav
    brandName: "SkillMesh",
    ecoTagMCP: "Anthropic · Tool Connection",
    ecoTagA2A: "Google · Agent Communication",
    ...
    aboutNotLi3: "Complements Skills: CCP trust + Skills description",
    ...
    aboutMoreLi3Desc: " — OpenAPI 3.0 spec + Swagger UI",
    aboutMoreLi4Title: "Health Dashboard",
    aboutMoreLi4Desc: " — real-time federation status",
    aboutMoreLi5Title: "Contributor Leaderboard",
    aboutMoreLi5Desc: " — browse community contributors",
    appHeroTitle: "Discover Reliable Capabilities",
    appHeroTitleLight: " · Trust-Driven Selection",
    exportMCPLabel: "MCP Client",
    exportDifyDesc: "Tool Config",
    navHome: "Home",
  ...
  ja: {
    ...
    // Nav
    brandName: "SkillMesh",
    ecoTagMCP: "Anthropic · ツール接続",
    ecoTagA2A: "Google · エージェント通信",
    ecoTagSkills: "Anthropic · 能力記述",
    comingSoon: "近日公開",
    forWhomCard1Li1: "LangChain / MCP / DSH / CrewAI マルチフレームワーク対応",
    forWhomCard1Li2: "5行で導入、npm install / pip install ですぐ使える",
    forWhomCard1Li3: "能力を貢献すると連邦検索に自動的に掲載",
    forWhomCard1Li4: "信頼ベクトルが自動更新、高品質な能力を優先表示",
    forWhomCard2Li1: "Difyプラグインは近日公開（ステージ10）",
    forWhomCard2Li2: "MCPプロトコルでワンクリック接続、コード不要",
    forWhomCard2Li3: "自然言語で能力を検索、IDを覚える必要なし",
    forWhomCard2Li4: "オンラインPlaygroundで各能力を直接体験",
    aboutVerifyLi1: "現状：プロトコル準備完了、データ蓄積中",
    aboutVerifyLi2: "成功基準：実在の外部貢献者 ≥ 5名、独立した連邦ノード ≥ 2",
    aboutVerifyLi3: "反証条件：3か月以内に外部採用なし",
    aboutNotLi1: "MCPと補完：CCP検索 + MCP接続",
    aboutNotLi2: "A2Aと補完：CCP信頼 + A2A通信",
    aboutNotLi3: "Skillsと補完：CCP信頼 + Skills記述",
    ...
    aboutMoreLi2Desc: " — ステージ10の計画とマイルストーン",
    aboutMoreLi3Title: "API ドキュメント",
    aboutMoreLi3Desc: " — OpenAPI 3.0 仕様 + Swagger UI",
    aboutMoreLi4Title: "ヘルスパネル",
    aboutMoreLi4Desc: " — 連邦ネットワークのリアルタイム状態",
    aboutMoreLi5Title: "コントリビューターランキング",
    aboutMoreLi5Desc: " — コミュニティ貢献者を表示",
    appHeroTitle: "信頼できる能力を発見",
    appHeroTitleLight: " · 信頼で選ぶ",
    exportMCPLabel: "MCP クライアント",
    exportDifyDesc: "ツール設定",
    navHome: "ホーム",
